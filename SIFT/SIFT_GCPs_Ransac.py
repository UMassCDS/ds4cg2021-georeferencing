...
# read images
mac = cv2.imread('C:/Users/sowmy/Desktop/DS4CG/GeoReferencing/GeoReferencing/mac_sample/mufs190-1952-cni5h100-i001.reference.tif')
...
mac_img=gdal.Open("C:/Users/sowmy/Desktop/DS4CG/GeoReferencing/GeoReferencing/mac_sample/mufs190-1952-cni5h100-i001.reference.tif")
mod_img = gdal.Open('C:/Users/sowmy/Desktop/DS4CG/GeoReferencing/GeoReferencing/sat_sample/18TXM900605/18TXM900605.jp2',gdal.GA_ReadOnly)
...
for i in range(0,len(matchesMask)):
    if matchesMask[i]==1:
        ...
        # Converting the pixel to coorsinates in corresponding systems
